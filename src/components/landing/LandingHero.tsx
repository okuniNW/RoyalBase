        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            ...
            <div className="flex items-center gap-3 mb-4">
              <span className="inflatable-3d-lime text-2xl sm:text-3xl font-bubble font-bold select-none tracking-tight">
                ROYALBASE
              </span>
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/85 backdrop-blur-md border border-white/80 text-[10px] font-mono font-bold text-sky-900 shadow-xs">
            ...
            <p className="mt-5 text-base sm:text-lg text-slate-800 font-medium leading-relaxed max-w-2xl">
              ...
              <strong className="text-slate-950 font-bold bg-lime-300/60 px-1.5 py-0.5 rounded-md">Prize Pool harian</strong> dengan gas fee sub-cent di Base L2.
            </p>

            {/* Action CTA Row with Vibrant Lime Button */}
            <div className="mt-7 flex flex-wrap items-center gap-3 w-full sm:w-auto">
              <button
                onClick={onLaunchApp}
                id="hero-launch-app-btn"
                className="px-7 py-3.5 rounded-full bg-lime-400 hover:bg-lime-300 active:bg-lime-500 text-slate-950 text-sm font-black tracking-tight flex items-center gap-2.5 shadow-[0_4px_16px_rgba(163,230,53,0.45)] border border-lime-300 transition-all transform hover:-translate-y-0.5 focus:outline-none cursor-pointer"
              >
            ...
            <div className="sky-card-solid rounded-3xl shadow-xl overflow-hidden border border-white/80">
              ...
              <div className="p-6 border-b border-sky-100/70 bg-gradient-to-b from-white to-sky-50/30">
                <div className="flex items-center justify-between text-xs text-slate-600 mb-1.5">
                  ...
                  <span className="font-mono text-sky-950 font-bold flex items-center gap-1 bg-lime-200/80 px-2 py-0.5 rounded-full text-[10px]">
                ...
                <div className="flex items-baseline justify-between gap-4 mt-2">
                  <div>
                    <div className="text-3xl sm:text-4xl font-black font-mono text-slate-950 tracking-tight">
                      {INITIAL_PRIZE_POOL.totalEth.toFixed(3)} <span className="text-xl text-sky-600">ETH</span>
                    </div>
              ...
              <div className="p-6">
                ...
                <div className="bg-sky-50/50 backdrop-blur-xs border border-sky-100 rounded-2xl p-3.5 space-y-2 text-xs font-mono">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-bold text-sky-700">+{calculatedPoolEth} ETH</span>
                  </div>
                  <div className="flex items-center justify-between pt-2 border-t border-sky-100">
                    ...
                    <span className="font-bold text-emerald-600">+{calculatedPoints} RP</span>
                  </div>
                </div>
                ...
                <button
                  ...
                  className="mt-4 w-full py-3 px-4 rounded-full bg-slate-950 hover:bg-slate-800 active:bg-black text-white text-xs font-extrabold flex items-center justify-center gap-2 transition-all cursor-pointer shadow-sm"
                >
